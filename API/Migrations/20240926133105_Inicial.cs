            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Autor = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FimLeitura = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    InicioLeitura = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UrlCapa = table.Column<string>(type: "varchar(300)", maxLength: 300, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
